...
<div class="main-div">
  ...
  <table width="100%" id="general-table">
      ...
      <tr>
        ...
        <td>
          <input type="radio" name="attr_type" id="" value="0" />唯一属性
          <input type="radio" name="attr_type" id="" value="1" />单选属性
        </td>
      </tr>
      <tr>
        <td class="label">属性值的录入方式:</td>
        <td>
          <input type="radio" name="attr_input_type" id="" value="0" />手工输入
          <input type="radio" name="attr_input_type" id="" value="1" />从下面的列表中选择(一行代表一个可选值)
        </td>
      </tr>
      <tr>
        <td class="label">可选值列表:</td>
        <td>
          <textarea name="attr_value" id="" cols="40" rows="10"></textarea>
        </td>
      </tr>
      <tr>
        <td></td>
